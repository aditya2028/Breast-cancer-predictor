...
@st.cache_resource
def load_resources():
    model = joblib.load(r'C:\Users\ABC\OneDrive\Desktop\bcp folder\Datasets and Models\lassifier.pkl')
    scaler = joblib.load(r'C:\Users\ABC\OneDrive\Desktop\bcp folder\Datasets and Models\scaler.pkl')
    return model, scaler
...
def main():
    ...
    st.set_page_config("Breast Cancer Prediction", r"C:\Users\ABC\OneDrive\Desktop\bcp folder\Related Images and Videos\breast.png", layout="wide")
    ...
    with open (r"C:\Users\ABC\OneDrive\Desktop\bcp folder\Related Images and Videos\breast.json") as f:
    ...
    X_test = pd.read_csv(r'C:\Users\ABC\OneDrive\Desktop\bcp folder\Datasets and Models\X_test.csv')
